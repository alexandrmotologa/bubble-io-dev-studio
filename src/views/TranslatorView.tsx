...
import { TranslationStudioTab } from './translator/TranslationStudioTab';
import { GlossaryTab } from './translator/GlossaryTab';
import { TranslationCacheTab } from './translator/TranslationCacheTab';
import { PseudoLocalizeTab } from './translator/PseudoLocalizeTab';
import { CostEstimationTab } from './translator/CostEstimationTab';
    ...
    <div className="view-container">
      ...
      {subTab === 'studio' && (
        <TranslationStudioTab
          ...
          selectedTargetLangs={selectedTargetLangs}
          viewMode={viewMode}
          setViewMode={setViewMode}
          activeDisplayLang={activeDisplayLang}
          setActiveDisplayLang={setActiveDisplayLang}
          activeProject={activeProject}
          onLog={onLog}
          handleFileUpload={handleFileUpload}
          handleLoadSampleStrings={handleLoadSampleStrings}
          handleUpdateTranslation={handleUpdateTranslation}
          handleTranslateSingleItem={handleTranslateSingleItem}
          handleTranslateMatrixRow={handleTranslateMatrixRow}
        />
      )}
      ...
      {subTab === 'glossary' && (
        <GlossaryTab
          ...
          setNewGlossaryTerm={setNewGlossaryTerm}
          newGlossaryRepl={newGlossaryRepl}
          setNewGlossaryRepl={setNewGlossaryRepl}
          handleInjectStandardGlossary={handleInjectStandardGlossary}
          handleAddGlossaryTerm={handleAddGlossaryTerm}
          handleRemoveGlossaryTerm={handleRemoveGlossaryTerm}
        />
      )}
      ...
      {subTab === 'pseudo' && (
        <PseudoLocalizeTab
          items={items}
          pseudoExpansionPercent={pseudoExpansionPercent}
          setPseudoExpansionPercent={setPseudoExpansionPercent}
          pseudoCustomInput={pseudoCustomInput}
          setPseudoCustomInput={setPseudoCustomInput}
          handleRunPseudoLocalization={handleRunPseudoLocalization}
        />
      )}
